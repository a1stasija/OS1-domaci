...
public:
    ...
    static void vectorTable(void)  __attribute__ ((naked, section(".text.vectorTable") ,aligned(16)));


private:
    //trap handlers
    static void baseTrap(); // da li treba __attribute__((interrupt("supervisor"))?
    static void timerTrap();
    static void consoleTrap();
    static void unhandledTrap();
    static void handleBaseTrap();
